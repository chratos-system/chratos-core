...
This document provides guidelines for internationalization of the Chratos Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `chratos_en.ts` remains unchanged.
