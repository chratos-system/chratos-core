...
unlocked to sign the Chratos-Qt.app bundle.
...
allowing somebody to distribute a Chratos-Qt.app or chratos-qt-setup.exe with a valid
...
that the chratos-qt.exe file inside the installer had not been tampered with.
