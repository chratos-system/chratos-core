...
#ifndef CHRATOS_QT_CHRATOSUNITS_H
#define CHRATOS_QT_CHRATOSUNITS_H
...
/** Chratos unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class ChratosUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ChratosUnits(QObject *parent);

    /** Chratos units.
      @note Source: https://en.chratos.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        CHR,
...
typedef ChratosUnits::Unit ChratosUnit;

#endif // CHRATOS_QT_CHRATOSUNITS_H
