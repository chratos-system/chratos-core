...
#ifndef CHRATOS_QT_WALLETFRAME_H
#define CHRATOS_QT_WALLETFRAME_H
...
public:
    explicit WalletFrame(const PlatformStyle *platformStyle, ChratosGUI *_gui = 0);
    ~WalletFrame();
...
#endif // CHRATOS_QT_WALLETFRAME_H
