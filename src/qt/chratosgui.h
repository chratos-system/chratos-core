...
#ifndef CHRATOS_QT_CHRATOSGUI_H
#define CHRATOS_QT_CHRATOSGUI_H
...
/**
  Chratos GUI main class. This class represents the main window of the Chratos UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ChratosGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit ChratosGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~ChratosGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a chratos wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
