...
void FreespaceChecker::check()
{
    ...
    try {
        ...
        if(fs::exists(dataDir))
        {
            ...
            {
                replyStatus = ST_OK;
                replyMessage = tr("Chratos will try to import an old wallet.dat file.");
            } else {
...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/chratos"));
        ...
        while(true)
        {
            ...
            try {
                ...
                /*
                WriteConfigFile("addnode", "95.183.52.55:3000");
                WriteConfigFile("addnode", "95.183.52.28:3000");
     ...
     * override -datadir in the chratos.conf file in the default data directory
     * (to be consistent with chratosd behavior)
     */
