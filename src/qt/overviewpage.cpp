...
public:
    TxViewDelegate(const PlatformStyle *platformStyle):
        QAbstractItemDelegate(), unit(ChratosUnits::CHR),
                      ...
                      const QModelIndex &index ) const
    {
        ...
        QString amountText = ChratosUnits::formatWithUnit(unit, amount, true, ChratosUnits::separatorAlways);
        if(!confirmed)
        {
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("CHR")
    updateDisplayUnit();
}
...
void OverviewPage::updateStakeReport(bool fImmediate=false)
{
    ...
    ui->label24hStakingStats->setText(ChratosUnits::formatWithUnit(unit, aRange[i++].Total, false, ChratosUnits::separatorAlways));
    ui->label7dStakingStats->setText(ChratosUnits::formatWithUnit(unit, aRange[i++].Total, false, ChratosUnits::separatorAlways));
    ui->label30dStakingStats->setText(ChratosUnits::formatWithUnit(unit, aRange[i++].Total, false, ChratosUnits::separatorAlways));
