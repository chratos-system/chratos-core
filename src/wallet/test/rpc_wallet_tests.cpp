...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    UniValue r;
    CPubKey demoPubkey;
    CChratosAddress demoAddress;
    UniValue retValue;
    string strAccount = "walletDemoAccount";
    CChratosAddress setaccountDemoAddress;
    {
        LOCK(pwalletMain->cs_wallet);

        demoPubkey = pwalletMain->GenerateNewKey();
        demoAddress = CChratosAddress(CTxDestination(demoPubkey.GetID()));
        ...
        setaccountDemoAddress = CChratosAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    }
    /*********************************
     * 			setaccount
     *********************************/
    ...
    BOOST_CHECK(CChratosAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CChratosAddress(arr[0].get_str()).Get() == demoAddress.Get());
