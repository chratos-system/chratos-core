 ...
 */
#ifndef CHRATOS_UTIL_H
#define CHRATOS_UTIL_H
...
extern const char * const CHRATOS_CONF_FILENAME;
extern const char * const CHRATOS_PID_FILENAME;
...
{
    std::string s = strprintf("chratos-%s", name);
