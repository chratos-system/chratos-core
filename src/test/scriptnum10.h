...
#ifndef CHRATOS_TEST_SCRIPTNUM10_H
#define CHRATOS_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Chratos Core 0.10.0, for cross-comparison.
 */
public:
