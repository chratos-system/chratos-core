...
// Copyright (c) 2017 The Chratos developers
 ...
 * between chratosd, and chratos-qt and non-server tools.
*/
...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-conf=<file>", strprintf(_("Specify configuration file (default: %s)"), CHRATOS_CONF_FILENAME));
    if (mode == HMM_CHRATOSD)
    {
#ifndef WIN32
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), CHRATOS_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/chratosdev/chratos-core>";
    const std::string URL_WEBSITE = "<https://chratos.org>";
...
/** Sanity checks
 *  Ensure that Chratos is running in a usable environment with all
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    // Make sure only a single Chratos process is using the data directory.
    ...
    if(GetBoolArg("-staking", true))
        threadGroup.create_thread(boost::bind(&ChratosStaker, boost::cref(chainparams)));
#endif
