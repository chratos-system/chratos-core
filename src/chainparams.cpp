...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    txNew.vout[0].scriptPubKey.clear();
    txNew.strDZeel = "Chratos genesis block";
...
{
    const char* pszTimestamp = "11/06/2018 - First Dividend Coin";
...
public:
    CMainParams() {
        ...
        consensus.nTargetSpacing = 150; // Blocktime: 2.5 minutes
        ...
        genesis = CreateGenesisBlock(1528728148, 87510, 0x1f00ffff, 1, 0);
        ...
        vSeeds.emplace_back("vidaru", "chratos.vidaru.org");
        ...
        checkpointData = (CCheckpointData) {
            ...
            ( 0, uint256S("0x00002c8ee799c9eca2b827f7fd5f166c920166676e1c420aafd30d1b4038c3d9")),
