...
class RawTransactionsTest(ChratosTestFramework):
    ...
    def run_test(self):
        ...
        try:
            ...
            raise AssertionError("Accepted invalid chratos address")
        except JSONRPCException as e:
            assert("changeAddress must be a valid chratos address" in e.error['message'])
